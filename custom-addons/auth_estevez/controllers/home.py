...
class ThemeHome(AuthSignupHome):
    def _get_login_page_settings(self):
        ...
        request.params['login_page_design'] = params.get_param('auth_estevez.login_page_design')
        request.params['login_page_custom_background'] = params.get_param('auth_estevez.login_page_custom_background')

        request.params['login_page_show_motto'] = params.get_param('auth_estevez.login_page_show_motto')
        request.params['login_page_motto_text_color'] = params.get_param('auth_estevez.login_page_motto_text_color')
        request.params['login_page_motto_text'] = params.get_param('auth_estevez.login_page_motto_text')
        request.params['login_page_motto_author'] = params.get_param('auth_estevez.login_page_motto_author')
